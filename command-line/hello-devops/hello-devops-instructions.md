...
1- get-ready
Create in your [Gitea](https://platform.zone01.gr/git/user/login) account the repository named `piscine-scripting`.
...
`git clone https://platform.zone01.gr/git/01-user/piscine-scripting.git`
...
`$ bash hello-devops.sh Hello 01-user! $`
3- go-say-hello
